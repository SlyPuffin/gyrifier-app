    ...
    <nav className="rounded border-gray-200 bg-white px-2 py-2.5 dark:bg-gray-800 sm:px-4">
      <div className="container mx-auto flex flex-wrap items-center justify-between">
        ...
        <button
          ...
          onClick={toggleClass}
          type="button"
          className={`border ml-3 inline-flex items-center rounded-lg p-2 text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 md:hidden`}>
        ...
        <div className={`${isActive? "hidden" : ""} w-full md:block md:w-auto`} id="mobile-menu">
